...
![GitHub](https://img.shields.io/github/license/jomrr/ansible-role-chrony) ![GitHub last commit](https://img.shields.io/github/last-commit/jomrr/ansible-role-chrony) ![GitHub issues](https://img.shields.io/github/issues-raw/jomrr/ansible-role-chrony)
...
A simple default example playbook for using jomrr.chrony.
```yaml
---
# name: "jomrr.chrony"
